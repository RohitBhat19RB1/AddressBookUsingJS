...
AddContacts('RohitDas','Bhat','Gandhichowk','Bantumilli','Andhrapradesh','521324','8712443377','rohit@gmail.com');
AddContacts('Rohit','Bhat','Gandhichowk','Bantumilli','Telangana','521324','8712443377','rohit@gmail.com');
...
console.log(searchContactWithCity("RohitDas", "Bhat", "Bantumilli"));
console.log(searchContactWithState("RohitDas", "Bhat", "Andhrapradesh"));
...
console.log(viewContactWithCity("RohitDas", "Bhat", "Bantumilli"));
console.log(viewContactWithState("RohitDas", "Bhat", "Andhrapradesh"));
